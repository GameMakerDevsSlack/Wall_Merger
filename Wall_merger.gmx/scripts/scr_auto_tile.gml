...
iw          = sprite_width;
w_left      = place_meeting(x-iw,y,objId);
w_right     = place_meeting(x+iw,y,objId);
w_up        = place_meeting(x,y-iw,objId);
w_down      = place_meeting(x,y+iw,objId);
w_upleft    = place_meeting(x-iw,y-iw,objId);
w_downleft  = place_meeting(x-iw,y+iw,objId);
w_upright   = place_meeting(x+iw,y-iw,objId);
w_downright = place_meeting(x+iw,y+iw,objId);
